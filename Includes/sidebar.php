      ...
      <div class="sidebar-heading">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap2"
          ...
          <span>Manage Bankers</span>
        </a>
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Bankers</h6>
            <a class="collapse-item" href="viewStudents.php">View Bankers</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewAttendance.php">View Bank Attendance</a>
            <a class="collapse-item" href="viewStudentAttendance.php">View Banker Attendance</a>
